...
RUN rm -rf glibc-2.29 &&  \
#    mv /lib/x86_64-linux-gnu/libm.so.6 /lib/x86_64-linux-gnu/libm.so.6.origin &&  \
#    mv /lib/x86_64-linux-gnu/libc.so.6 /lib/x86_64-linux-gnu/libc.so.6.origin && \
    ln -nfs /usr/local/lib/libm.so.6 /lib/x86_64-linux-gnu/ && \
    ln -nfs /usr/local/lib/libc.so.6 /lib/x86_64-linux-gnu/
